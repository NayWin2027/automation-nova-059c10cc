      ...
      >
        ...
        >
          ...
          <p className="text-xs leading-relaxed mb-3" style={{ color: "hsl(220 20% 75%)" }}>
            ...
            🟣မိမိဖုန်းနဲ့ကွန်ပျူတာများရဲ့ CPU၊ GPU၊ RAM Specifications များကို မသိပါကလည်း Page Messenger or Viber
            No-09967793288 ကနေ အချိန်မရွေးလာရောက်မေးမြန်းနိုင်ပါတယ်။ ။
          </p>
