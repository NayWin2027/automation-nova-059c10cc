...
const AdminDailyUsageTab: React.FC = () => {
  ...
  const mergedUsageData: DailyUsage[] = (() => {
    ...
    const normalizedBases = bases
      ...
      .filter((base) => (base.usage_count || 0) > 0 || (base.success_count || 0) > 0 || (base.error_count || 0) > 0 || (base.deduct_count || 0) > 0);

    return [
      ...variants,
      ...normalizedBases.filter((b) => !variantsByKey.has(`${b.user_id}|${b.tool_id}`)),
