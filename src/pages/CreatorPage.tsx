        ...
        <div className="bg-card rounded-[32px] p-5 space-y-5 border border-border/50 shadow-xl relative overflow-hidden">
          ...
          <div className="flex justify-between items-center px-1">
            <div className="space-y-0.5">
              <h2 className="font-black tracking-tighter text-foreground text-3xl">
                CONTENT CREATOR <span className="text-primary">NOVA</span>
              </h2>
          ...
          <div className="grid grid-cols-2 gap-2 pt-1">
            ...
            >
              ...
              <p
                className={`text-[11px] font-black uppercase tracking-tight ${seoViral ? "text-amber-400" : "text-slate-500"}`}
              >
                {seoViral ? "ON" : "OFF"}
              </p>
            </button>
            ...
            >
              ...
              <p
                className={`text-[11px] font-black uppercase tracking-tight ${withImage ? "text-emerald-400" : "text-slate-500"}`}
              >
                {withImage ? "WITH IMG" : "TEXT ONLY"}
              </p>
            </button>
          </div>
          ...
          <div className="pt-2">
            ...
            >
              {loading ? (
                <>
                  <div className="w-3 h-3 border-2 border-amber-950/20 border-t-amber-950 rounded-full animate-spin"></div>{" "}
                  PROCESSING...
                </>
              ) : (
                "GENERATE CONTENT"
