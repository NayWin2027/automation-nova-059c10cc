        ...
        <div className="bg-white/5 backdrop-blur-2xl rounded-[28px] p-5 border border-white/10 space-y-3 shadow-xl">
          <div className="flex justify-between items-center px-1">
            <div className="flex items-center gap-[12px]">
              ...
              <span className="bg-background/50 px-2 py-0.5 rounded-lg font-black text-sm text-neon-rose">
                {text.length}/4500
              </span>
            </div>
            {!isEditing && (
        ...
        <div className="space-y-4">
          <div className="space-y-2 text-neon-cyan bg-violet-900">
            {isEditing ? (
              ...
              <h4
                className="font-black uppercase tracking-widest ml-1 text-xs text-neon-rose"
          ...
          <div className="space-y-2">
            {isEditing ? (
              ...
              <h4
                className="font-black uppercase tracking-widest ml-1 text-sm"
