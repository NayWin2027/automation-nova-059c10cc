...
const VoicePage: React.FC = () => {
  ...
  const handleCheckWordCount = () => {
    ...
    if (len <= t1) setSelectedTier(t1);else
    if (len <= t2) setSelectedTier(t2);else
    if (len <= t3) setSelectedTier(t3);else
    setSelectedTier(t4);
    setTierLocked(true);
  };
  ...
  const handleGenerate = async () => {
    ...
    if (apiType === 'app') {
      ...
      if (selectedTier !== null) {
        ...
        let creditText = '';
        if (selectedTier === (s.tier1Value || 1500)) creditText = s.tier1Credits;else
        if (selectedTier === (s.tier2Value || 2500)) creditText = s.tier2Credits;else
        if (selectedTier === (s.tier3Value || 3500)) creditText = s.tier3Credits;else
        if (selectedTier === (s.tier4Value || 4500)) creditText = s.tier4Credits;
        ...
        <div className="space-y-3 pt-2">
          <div className="bg-white/5 border border-white/10 rounded-[28px] p-6 space-y-3 shadow-inner text-gold">
            <div className="flex items-center gap-2">
              ...
              <h4 className="font-black uppercase tracking-[0.2em] text-base text-neon-rose" style={{ color: vs?.howToUseTitleColor || defaultVoiceSettings.howToUseTitleColor }}>
            ...
            <div className="space-y-2 font-bold leading-relaxed rounded-lg shadow-lg px-0 pb-0 pr-0 text-secondary-foreground" style={{ color: vs?.howToUseTextColor || defaultVoiceSettings.howToUseTextColor, fontSize: (vs?.howToUseTextSize || defaultVoiceSettings.howToUseTextSize) + 'px' }}>
          ...
          <div className="bg-amber-400/5 border border-amber-400/20 rounded-[28px] p-6 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <h4 className="font-black uppercase tracking-[0.2em] text-base" style={{ color: vs?.proTipsTitleColor || defaultVoiceSettings.proTipsTitleColor }}>
            ...
            <div className="space-y-2 font-bold leading-relaxed text-destructive-foreground" style={{ color: vs?.proTipsTextColor || defaultVoiceSettings.proTipsTextColor, fontSize: (vs?.proTipsTextSize || defaultVoiceSettings.proTipsTextSize) + 'px' }}>
