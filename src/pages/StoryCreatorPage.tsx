        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2 text-destructive">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-2xl font-black transition-all border ${selectedGenres.includes(genre) ? "jewel-sapphire border-transparent text-white shadow-lg" : "bg-black/40 border-white/5 text-slate-300 hover:text-slate-200"}`}>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className={`py-4 rounded-[20px] font-black text-2xl uppercase border transition-all ${authorStyle === "master" ? "jewel-sapphire text-white border-transparent shadow-lg" : "bg-black/40 text-slate-300 border-white/5"}`}>

              MASTER STORYTELLER
            </button>
            <button
              onClick={() => setAuthorStyle("modern")}
              className={`py-4 rounded-[20px] font-black text-2xl uppercase border transition-all ${authorStyle === "modern" ? "jewel-emerald text-white border-transparent shadow-lg" : "bg-black/40 text-slate-300 border-white/5"}`}>
          ...
          <div className="space-y-2 max-h-80 overflow-y-auto custom-scrollbar pr-1">
            ...
            <div
              ...
              className="flex flex-col gap-2 p-3 rounded-xl border border-white/5 animate-in slide-in-from-left-2 bg-gray-300">
                ...
                <div className="flex items-center gap-2">
                  <span
                  className={`px-2 py-1 rounded-lg text-lg font-black uppercase shadow-md tracking-wider w-auto text-center shrink-0 ${getCharColor(char.type)}`}>
                  ...
                  className="flex-1 bg-transparent border-none focus:ring-0 text-[30px] font-bold text-white placeholder:text-slate-500" />
                ...
                <div className="flex items-center gap-2 pl-18">
                  ...
                  className="flex-1 bg-slate-900/50 border border-white/10 rounded-lg py-1 px-2 text-2xl font-black outline-none focus:border-blue-500/50 text-neon-rose">
                  ...
                  className={`w-10 h-10 rounded-lg text-xl font-black flex items-center justify-center transition-colors uppercase shrink-0 ${char.gender === "Male" ? "bg-blue-500/20 text-blue-400" : "bg-pink-500/20 text-pink-400"}`}>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <select
                ...
                className="w-full bg-black/40 border border-white/10 rounded-xl p-3 text-[27px] font-bold text-white outline-none">
            ...
            <div className="grid grid-cols-1 gap-2">
              ...
              <button
                ...
                className={`p-3 rounded-xl text-left border transition-all ${storyPhase === p.id ? "bg-purple-600/20 border-purple-500 shadow-lg" : "bg-black/30 border-white/5 text-slate-500"}`}>
                  ...
                  <span
                  className={`text-[27px] font-black uppercase ${storyPhase === p.id ? "text-white" : "text-slate-400"}`}>
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button
                ...
                className={`px-3 py-2 rounded-xl text-2xl font-black uppercase border transition-all ${selectedFocus.includes(f.id) ? "bg-rose-600 text-white border-rose-500 shadow-lg" : "bg-black/30 border-white/5 text-slate-500"}`}>
