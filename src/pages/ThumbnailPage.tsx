...
const ThumbnailView: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-40 animate-in fade-in duration-500 max-w-5xl text-white bg-blue-600 my-px px-[5px] mx-0 sm:mx-auto">
      ...
      <button
        onClick={() => navigate("/")}
        className="fixed top-3 left-3 z-50 flex items-center gap-1.5 px-3 py-2 rounded-xl bg-black/40 backdrop-blur-md border border-white/10 hover:bg-black/60 transition-all duration-200 shadow-lg text-neon-rose">
