  ...
  return (
    <div className="min-h-screen bg-background pb-24">
            ...
            <button onClick={() => setShowGuide(!showGuide)} className="w-full p-3 flex justify-between items-center bg-white/5 hover:bg-white/10 transition-colors">
                <div className="flex items-center gap-[12px]">
                     ...
                     <div className="text-left">
                        <p className="font-black uppercase tracking-widest text-base text-white">လမ်းညွှန် (HOW TO USE)</p>
                        <p className="font-bold uppercase text-lg text-white">အသုံးပြုနည်း အဆင့်ဆင့်</p>
                     </div>
                </div>
      ...
      <div className="text-center opacity-30 pt-8 pb-4">
        <p className="tracking-[0.5em] uppercase text-xs text-black font-extrabold">POWERED BY GEMINI 1.5 PRO & FLASH • 350K ENGINE</p>
      </div>
    </div>
