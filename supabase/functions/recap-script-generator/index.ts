...
15. ### 3. BURMESE NARRATIVE STYLE & SENTENCE-ENDING VARIETY (CRITICAL REQUIREMENT)
To make the narration sound like a natural, engaging storyteller, the AI must strictly avoid robotic, repetitive sentence endings.

- **Strict Sentence-Ending Rotation:** NEVER end consecutive sentences with the same closing phrase. The exact same ending form must NOT appear in more than two (2) sentences in a row. 
- **Distribution Limit:** No single ending form (e.g., "...တယ်", "...တာပဲ") may cover more than 30% of the entire script or recap.
- **Dynamic Endings to Rotate (Examples):**
  - Standard/Narrative: ...တယ် / ...ခဲ့တယ် / ...လိုက်တယ် / ...ပါပဲ / ...ပြန်တယ်
  - Explanatory/Expressive: ...တာပဲ / ...တာပေါ့ / ...နေတာ / ...တော့တာပဲ / ...တာကိုး / ...ရှာတယ်
- **Emotional Reporting Verbs:** Never repeat a neutral "ပြောလိုက်ပါတယ်" (or standard dialogue tags) repeatedly. Match the character's emotion and the scene's tone by dynamically varying reporting verbs:
  - *Angry/Stern:* ...လို့ ကြိမ်းမောင်းတယ် / ...လို့ သတိပေးလိုက်တယ်
  - *Sad/Complaining:* ...လို့ ညည်းတွားရှာတယ် / ...လို့ ဝမ်းနည်းတုန်လှုပ်စွာ ရေရွတ်မိတယ်
  - *Loud/Shocked:* ...လို့ အော်ဟစ်လိုက်တယ် / ...လို့ ကုန်းအော်တယ်
  - *Amused/Sarcastic:* ...လို့ လှောင်ပြောင်ရယ်မောတယ် / ...လို့ ရယ်ကျဲကျဲ ပြန်ပြောတယ်
- **Past Events Handling:** For past actions or completed events, strongly prefer active past forms like "...ခဲ့တယ်", "...လုပ်လိုက်တယ်", or "...ပြောပြတယ်".
- **Non-Burmese Target Languages:** If generating in languages other than Burmese, apply the exact same core principle of natural, conversational, and highly varied spoken sentence endings.

- **Comprehensive Example (Before vs. After):**
  * BAD (Repetitive & Monotone): 
    သူတို့ထွက်သွားတော့ ကောင်မလေးခမျာ တစ်ယောက်တည်း ကျန်ခဲ့တာပေါ့။ ဟိုရောက်တော့ ကောင်လေးတွေဟာ အလုပ်ကြမ်းတွေလုပ်ပြီး နှိပ်စက်ခံရတာပေါ့။ အဲဒီမှာက လူဆိုးတွေချည်းပဲ နေကြတာပေါ့။ ပြီးတော့ လူဆိုးခေါင်းဆောင်က မင်းတို့ ငါ့ဆီက ပြေးလို့မရဘူးလို့ ပြောလိုက်ပါတယ်။ အဲဒီအချိန်မှာ ကောင်လေးတစ်ယောက်က ကယ်ကြပါဦးလို့ ပြောလိုက်ပါတယ်။ ဒါပေမဲ့ ဘယ်သူမှ လာမကယ်ကြတာပေါ့။ နောက်တော့ ကောင်မလေးကလည်း သူတို့ကို လိုက်ရှာဖို့ ဆုံးဖြတ်လိုက်တာပေါ့။ လမ်းမှာ ဘီလူးကြီးနဲ့ တွေ့တော့ ကောင်မလေးက အရမ်းကြောက်သွားတာပေါ့။ ဘီလူးကြီးကလည်း မင်းကို စားပစ်မယ်လို့ ပြောလိုက်တာပေါ့။
  * GOOD (Vivid Movie Recap Style - Highly Varied & Natural Spoken Flow): 
    သူတို့အုပ်စု ထွက်သွားတဲ့အချိန်မှာပဲ ကောင်မလေးခမျာ ဘာလုပ်ရမှန်းမသိဘဲ တစ်ယောက်တည်း အထီးကျန်ဆန်ဆန် ကျန်ရစ်ခဲ့ချာတယ်။ တစ်ဖက်မှာလည်း ဟိုဘက်ကိုပါသွားတဲ့ ကောင်လေးတွေခမျာ ရောက်ရောက်ချင်းပဲ အလုပ်ကြမ်းတွေလုပ်ပြီး နှိပ်စက်တာကို ခံရတော့တာပဲ။ ဘာလို့လဲဆိုတော့ အဲဒီနေရာတစ်ခုလုံးမှာက လူဆိုးကောင်တွေချည်းပဲ ကြီးစိုးနေကြတာကိုး။ "မင်းတို့ ငါ့လက်ထဲက ပြေးလို့လွတ်မယ်မထင်နဲ့" ဆိုပြီး လူဆိုးခေါင်းဆောင်က မာန်မဲပြီး ကြိမ်းမောင်းလိုက်တော့ သူတို့ထဲက ကောင်လေးတစ်ယောက်ခမျာ ကြောက်လန့်တကြားနဲ့ "ကယ်ကြပါဦးဗျာ" လို့ အော်ဟစ်အကူအညီတောင်းလိုက်တယ်။ ဒါပေမဲ့လည်း အနားမှာ ဘယ်သူမှရှိမနေတော့ အားလုံးဟာ ကူရာကယ်ရာမဲ့ပြီး ရင်တထိတ်ထိတ်နဲ့ ကျန်ခဲ့တာပေါ့။ 

    ဒီလိုနဲ့ ရွာမှာကျန်ခဲ့တဲ့ ကောင်မလေးဟာလည်း ထိုင်ငိုမနေတော့ဘဲ သူငယ်ချင်းတွေကို ကယ်ဖို့အတွက် တောနက်ထဲကို တစ်ယောက်တည်း လိုက်သွားဖို့ ဆုံးဖြတ်လိုက်တယ်။ လမ်းခရီး အလယ်လောက် ရောက်တဲ့အချိန်မှာတော့ ထင်မှတ်မထားဘဲ ဧရာမ ဘီလူးကြီးတစ်ကောင်နဲ့ ဝုန်းခနဲ တိုးမိပါလေရော။ ကောင်မလေးခမျာ သွေးပျက်မတတ် ကြောက်လန့်သွားပြီး ခြေဖျားလက်ဖျားတွေပါ တုန်လှုပ်ကုန်တာပေါ့။ အဲဒီမှာတင် ဘီလူးကြီးက လျှာကြီးသပ်ရင်းနဲ့ "မင်းကို ငါအရှင်လတ်လတ် ဝါးစားပစ်မယ်" လို့ ဟိန်းဟောက်ပြီး ခြိမ်းခြောက်လိုက်ပါတော့တယ်။
...
- ENDING VARIETY: ### 3. BURMESE NARRATIVE STYLE & SENTENCE-ENDING VARIETY (CRITICAL REQUIREMENT)
To make the narration sound like a natural, engaging storyteller, the AI must strictly avoid robotic, repetitive sentence endings.
