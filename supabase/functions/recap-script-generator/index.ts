...
- 100% of the spoken lines must appear. Zero skipping, zero merging, zero replacing a line with a summary. Narrator/action lines stay at ~15% only.
...
- NARRATOR'S ROLE (PLOT BRIDGES, ACTION & RELATIONSHIPS - 15%): Narrator lines are NOT optional filler — they are essential story glue. Insert narrator paragraphs to:
