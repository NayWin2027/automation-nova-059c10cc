...
- Balance dialogue with narration: dialogue is the star (~100%), but narrator/action lines (~5%) are ESSENTIAL for story flow and professional quality.
...
- 100% of the spoken lines must appear. Zero skipping, zero merging, zero replacing a line with a summary. Narrator/action lines stay at ~5% only.
...
- NARRATOR'S ROLE (PLOT BRIDGES, ACTION & RELATIONSHIPS - 5%): Narrator lines are NOT optional filler — they are essential story glue. Insert narrator paragraphs to:
