...
serve(async (req) => {
  ...
  try {
    ...
    // ── Native realistic voice style per language ──
    const nativeStyleMap: Record<string, string> = {
      my: "CRITICAL VOICE STYLE: You are a native Burmese (Bamar) speaker from Yangon. Speak EXACTLY like a real young urban Burmese human — 100% authentic Bamar/Yangon colloquial dialect, natural rhythm, modern intonation. Your pronunciation must be indistinguishable from a real Yangon native. STRICTLY FORBIDDEN: Shan accent, Kachin accent, Chinese accent, Karen accent, Indian accent, European accent, robotic tone, overly formal tone, or any foreign phoneme bleed. Use natural Burmese glottal stops, tones, and vowel lengths exactly as a native speaker would. Speak with warmth, confidence, and natural human expressiveness like a Burmese content creator or news presenter.",
      en: "CRITICAL VOICE STYLE: Speak in clear, natural, modern conversational American English with authentic native-speaker rhythm and intonation.",
      ...
      zh: "CRITICAL VOICE STYLE: Speak in natural, modern colloquial Mandarin Chinese with authentic standard Beijing (Putonghua) accent.",
    };
